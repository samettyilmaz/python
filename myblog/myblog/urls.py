...
urlpatterns = patterns('',
    ...
    url(r'^post/(?P<id>[0-9]+)$','mypages.views.view_post',name='blog_post_detail'),
    url(r'^post/like/(?P<id>[0-9]+)$','mypages.views.like_post',name='like_post'),
    url(r'^edit/(?P<id>[0-9]+)$','mypages.views.edit_post',name='blog_post_edit'),
    url(r'^delete/(?P<id>[0-9]+)$','mypages.views.delete_post',name='blog_delete_post'),
